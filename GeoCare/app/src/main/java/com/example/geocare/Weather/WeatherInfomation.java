...
public class WeatherInfomation extends AppCompatActivity {

    EditText cityEdittext, countryEdittext;
    TextView weatherResult;
    Button button;
    private final String url = "https://api.openweathermap.org/data/2.5/weather";
    private final String appid = "dcfabdd5c7fc896819d09133733b7eea";
    ...
    private void fetch_UI() {
        ...
        weatherResult = (TextView) findViewById(R.id.weahterInfo);
